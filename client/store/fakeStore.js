...
export const dummyHandleChange = event => console.log(`dummyHandleChange was invoked with this event: ${event}`);

export const dummyRightBook = { id: 0 };
...
export const persuasionSentenceArray = [
  ...
  ', whose rights had been so generously supported by her father, had disappointed her.',
  ...
  'Chapter 3  "I must take leave to observe, Sir Walter," said Mr Shepherd one morning at Kellynch Hall, as he laid down the newspaper, "that the present juncture is much in our favour.',
  ...
  'Very odd indeed!',
  '" After waiting another moment-- "You mean Mr Wentworth, I suppose?"',
  'said Anne.',
  ...
  'Chapter 5  On the morning appointed for Admiral and Mrs Croft’s seeing Kellynch Hall, Anne found it most natural to take her almost daily walk to Lady Russell’s, and keep out of the way till all was over; when she found it most natural to be sorry that she had missed the opportunity of seeing them.',
  ...
  'Chapter 6  Anne had not wanted this visit to Uppercross, to learn that a removal from one set of people to another, though at a distance of only three miles, will often include a total change of conversation, opinion, and idea.',
  ...
  '" He was cut short by the eager attacks of the little boys, clinging to him like an old friend, and declaring he should not go; and being too much engrossed by proposals of carrying them away in his coat pockets, &c.',
  ...
  '"  Chapter 8  From this time Captain Wentworth and Anne Elliot were repeatedly in the same circle.',
  ...
  'Chapter 9  Captain Wentworth was come to Kellynch as to a home, to stay as long as he liked, being as thoroughly the object of the Admiral’s fraternal kindness as of his wife’s.',
  ...
  'Chapter 10  Other opportunities of making her observations could not fail to occur.',
  ...
  'They praised the morning; gloried in the sea; sympathized in the delight of the fresh-feeling breeze--and were silent; till Henrietta suddenly began again with-- "Oh!',
  ...
  '"She is dead!',
  'she is dead!',
  '" screamed Mary, catching hold of her husband, and contributing with his own horror to make him immoveable; and in another moment, Henrietta, sinking under the conviction, lost her senses too, and would have fallen on the steps, but for Captain Benwick and Anne, who caught and supported her between them.',
  ...
  '" "A surgeon!"',
  'said Anne.',
  'He caught the word; it seemed to rouse him at once, and saying only-- "True, true, a surgeon this instant," was darting away, when Anne eagerly suggested-- "Captain Benwick, would not it be better for Captain Benwick?',
  ...
  '" was uttered by Captain Wentworth, Anne was sure could never be forgotten by her; nor the sight of him afterwards, as he sat near a table, leaning over it with folded arms and face concealed, as if overpowered by the various feelings of his soul, and trying by prayer and reflection to calm them.',
  ...
  '" and there was a Mrs Wallis, at present known only to them by description, as she was in daily expectation of her confinement; but Mr Elliot spoke of her as "a most charming woman, quite worthy of being known in Camden Place," and as soon as she recovered they were to be acquainted.',
  ...
  'Anne drew a little back, while the others received his compliments, and her sister his apologies for calling at so unusual an hour, but "he could not be so near without wishing to know that neither she nor her friend had taken cold the day before," &c.',
  '&c; which was all as politely done, and as politely taken, as possible, but her part must follow then.',
  ...
  'He had spent his whole solitary evening in the room adjoining theirs; had heard voices, mirth continually; thought they must be a most delightful set of people, longed to be with them, but certainly without the smallest suspicion of his possessing the shadow of a right to introduce himself.',
  ...
  'Chapter 16  There was one point which Anne, on returning to her family, would have been more thankful to ascertain even than Mr Elliot’s being in love with Elizabeth, which was, her father’s not being in love with Mrs Clay; and she was very far from easy about it, when she had been at home a few hours.',
  ...
  '--she believed, in short, what Anne did not believe.',
  ...
  'Chapter 18  It was the beginning of February; and Anne, having been a month in Bath, was growing very eager for news from Uppercross and Lyme.',
  ...
  'There, take my arm; that’s right; I do not feel comfortable if I have not a woman there.","Lord!',
  'what a boat it is!',
  ...
  'As soon as they were fairly ascending Belmont, he began-- "Well, now you shall hear something that will surprise you.',
  ...
  '"  Chapter 19  While Admiral Croft was taking this walk with Anne, and expressing his wish of getting Captain Wentworth to Bath, Captain Wentworth was already on his way thither.',
  ...
  'All this is much, very much in favour of their happiness; more than perhaps--" He stopped.',
  ...
  'I assure you, Mr Elliot had not the share which you have been supposing, in whatever pleasure the concert of last night might afford: not Mr Elliot; it is not Mr Elliot that--" She stopped, regretting with a deep blush that she had implied so much; but less would hardly have been sufficient.',
  ...
  'At last-- "I beg your pardon, my dear Miss Elliot," she cried, in her natural tone of cordiality, "I beg your pardon for the short answers I have been giving you, but I have been uncertain what I ought to do.',
  ...
  '" Mrs Musgrove was good humouredly beginning to express her perfect readiness for the play, if Henrietta and all the others liked it, when Mary eagerly interrupted her by exclaiming-- "Good heavens, Charles!',
  ...
  'I always think that no mutual--" "Oh!',
