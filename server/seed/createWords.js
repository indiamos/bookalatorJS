...
// // For each book in the array, tokenize its text, add those words to the db, and add a connection row to the BooksWords table.
...
//   return Promise.map(generateWords(), function (word) {
//     return word.save();
//   });
// }
