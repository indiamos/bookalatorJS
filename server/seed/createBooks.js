...
// additional seed books can be added by placing the text files in /server/seed/corpus/ and using convertToString() to import them.
const fs = require('fs');
...
function createBooks () {
  return Promise.map(generateBooks(), function (book) {
    return book.save();
  });
}
